...
namespace SCPSLAudioApi.Events.Handlers
{
    public class Track
    {
        ...
        public delegate void TrackFinished(AudioPlayerBase playerBase, string track, bool directPlay,
        ...
        public static void InvokeTrackSelectedEvent(AudioPlayerBase playerBase, bool directPlay, int queuePos,
            ref string track)
        {
        ...
        public static void InvokeTrackLoadedEvent(AudioPlayerBase playerBase, bool directPlay, int queuePos,
            string track)
        {
        ...
        public static void InvokeFinishedTrackEvent(AudioPlayerBase playerBase, string track, bool directPlay,
            ref int nextQueuePos)
        {
